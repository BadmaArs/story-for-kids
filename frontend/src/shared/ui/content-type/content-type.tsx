        ...
        <div className="flex w-full flex-col justify-center md:flex-row md:gap-3">
            <div className="card w-full bg-base-300 rounded-box grid h-auto place-items-center p-2">
                <div className="w-full max-w-screen-lg aspect-w-16 aspect-h-9">
                    <ReactPlayer
                        url="https://videocdn.cdnpk.net/videos/fd7e918a-0d3b-4c38-ad02-f07d8435f8ad/horizontal/previews/clear/large.mp4?token=exp=1728034634~hmac=da6d2db521d70abf34beae6d28fac39e558162a6b9858c5ac9019416d59c7315"
                        controls
                        width="100%"
                        height="100%"
                    />
